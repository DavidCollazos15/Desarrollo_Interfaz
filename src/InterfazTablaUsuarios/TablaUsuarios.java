...
public class TablaUsuarios {
    public static void main(String[] args) {
        ...
        ventana.setBounds(10, 10, 700, 400);
        ...
        ordenar.gridy = 0;
        container.add(TituloPanel, ordenar);

        ordenar.gridx = 0;
        ordenar.gridy = 1;
        container.add(inputPanel, ordenar);

        ordenar.gridy = 2;
        container.add(buttonPanel, ordenar);

        ordenar.weighty = 1.0;
        ordenar.gridy = 3;
        container.add(scrollPane, ordenar);
